...
\begin{center}
    \begin{tabular}{cc}
    	\includegraphics[width=0.2\textwidth]{images/qr/case.pdf} \hspace{20mm} & \includegraphics[width=0.2\textwidth]{images/qr/infovaya.pdf}
    \end{tabular}
\end{center}
...
\chapter{Events}
    \begin{multicols*}{2}
        \begin{tabular}{p{75mm}}
            ...
            \vspace{2mm} \\
            Join us at the rooftop of Nicolaus Hotel for the Welcome and Farewell Ceremonies. You will enjoy a stunning view of the entire town while indulging in delicious typical Apulian foods. It’s a perfect setting to connect with fellow participants. \\ \\

            \parbox{75mm}{\section{Gala Dinner}} \vspace{1mm} \\
            \textit{30 August, Corte di Torrelonga, 20:00 – 21:30} \vspace{2mm} \\
            \textit{Included in the (in-person) full and student registration fees} \vspace{2mm} \\
            Indulge in an evening of elegance and opulence at the prestigious Villa de Grecis, an old Italian Villa — delight in fine dining, entertainment, and camaraderie within the historic walls of this enchanting venue. Transportation service is included. \\ \\ 
